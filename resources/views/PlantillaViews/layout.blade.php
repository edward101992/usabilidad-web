          ...
          <!-- END SIDEBAR -->
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                 ...
                 @if(Entrust::hasRole('administrador'))
               <strong>
                    <h1 class="page-title" style="color:#3489C0;"> Usabilidad-Web Administrador
               ...
               <strong>
                    <h1 class="page-title" style="color:#3489C0;"> Usabilidad-Web Evaluador
               ...
               <strong>
                    <h1 class="page-title" style="color:#3489C0;"> Usabilidad-Web Estudiante
