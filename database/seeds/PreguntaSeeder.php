...
class PreguntaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /**
    	 * Encuesta Accesibilidad de la Informacion
    	 */
    	...
    	$pregunta = Pregunta::create([
    		...
    		'pregunta_descripcion'=>'Considera que su interacción con la página web fue enriquecedora',
			'encuesta_id'=>5
