       ...
       @section('contenido')
                                        ...
                                        <div class="portlet light ">
                                            <div class="portlet-title tabbable-line">
                                                <div class="caption caption-md">
                                                    ...
                                                    <span class="caption-subject font-blue-madison bold uppercase">PREGUNTAS</span>
                                                </div>
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#tab_1_1" data-toggle="tab">SATISFACCION</a>
                                                    </li>
                                                    <li>
                                                        <a href="#tab_1_2" data-toggle="tab">EFICACIA</a>
                                                    </li>
                                                    <li>
                                                        <a href="#tab_1_3" data-toggle="tab">EFICIENCIA</a>
                                                    </li>
                                                </ul>
                                            </div>
         ...
         <div class="note note-info">
            <p>Ver Preguntas del cuestionario para medir la usabilidad </p>
        </div>
            @endsection